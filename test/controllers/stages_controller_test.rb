...
class StagesControllerTest < ActionController::TestCase
  ...
  test "should create stage" do
    assert_difference('Stage.count') do
      post :create, stage: { date: @stage.date, finish: @stage.finish, gyara: @stage.gyara, name: @stage.name, start: @stage.start }
    end
  ...
  test "should update stage" do
    patch :update, id: @stage, stage: { date: @stage.date, finish: @stage.finish, gyara: @stage.gyara, name: @stage.name, start: @stage.start }
    assert_redirected_to stage_path(assigns(:stage))
  end
